...
public class LuggageArrayAdapterNoCheckbox extends ArrayAdapter<Luggage> {




    public LuggageArrayAdapterNoCheckbox(Context context, List<Luggage> aLuggage) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.luggage_adapter_layout_no_checkbox, parent, false);
        }
