...
*/
    ...
    public void drawLuggages(Canvas c){
        ...
        for(int i =0;i<trunk.howLuggages();i++) {
            ...
            Path luggageV = new Path();
            luggageV.reset();
            luggageV.moveTo((float) (y + (float)(trunk.getLuggage(i).getyView()*5.38)- trunk.getLuggage(i).getLengthScale() / Math.sqrt(2.0)) - (float)(trunk.getLuggage(i).getxView()*1.19) , (float) (x + trunk.getLuggage(i).getLengthScale() / Math.sqrt(2.0)) -  (float)(trunk.getLuggage(i).getzView()*2.85) + (float)(trunk.getLuggage(i).getxView()*1.2));
            luggageV.lineTo((float) (y + (float)(trunk.getLuggage(i).getyView()*5.38)- trunk.getLuggage(i).getLengthScale() / Math.sqrt(2.0)) - (float)(trunk.getLuggage(i).getxView()*1.19), (float) (x - trunk.getLuggage(i).getHeightScale() + trunk.getLuggage(i).getLengthScale() / Math.sqrt(2.0)-  (float)(trunk.getLuggage(i).getzView()*2.85)+ (float)(trunk.getLuggage(i).getxView()*1.2)));
            luggageV.lineTo(y+(float)(trunk.getLuggage(i).getyView()*5.38)- (float)(trunk.getLuggage(i).getxView()*1.19), x - trunk.getLuggage(i).getHeightScale() -  (float)(trunk.getLuggage(i).getzView()*2.85)+ (float)(trunk.getLuggage(i).getxView()*1.2) );
            luggageV.lineTo(y + trunk.getLuggage(i).getWidthScale() + (float)(trunk.getLuggage(i).getyView()*5.38)- (float)(trunk.getLuggage(i).getxView()*1.19), x - trunk.getLuggage(i).getHeightScale() - (float)(trunk.getLuggage(i).getzView()*2.85) + (float)(trunk.getLuggage(i).getxView()*1.2));
            luggageV.lineTo(y + trunk.getLuggage(i).getWidthScale()+(float)(trunk.getLuggage(i).getyView()*5.38)- (float)(trunk.getLuggage(i).getxView()*1.19), x + (float)(trunk.getLuggage(i).getxView()*1.2) -  (float)(trunk.getLuggage(i).getzView()*2.85));
            luggageV.lineTo((float) (y + trunk.getLuggage(i).getWidthScale() - trunk.getLuggage(i).getLengthScale() / Math.sqrt(2.0)+(float)(trunk.getLuggage(i).getyView()*5.38))- (float)(trunk.getLuggage(i).getxView()*1.19), (float) (x + trunk.getLuggage(i).getLengthScale() / Math.sqrt(2.0))- (float)(trunk.getLuggage(i).getzView()*2.85) + (float)(trunk.getLuggage(i).getxView()*1.2));
            ...
            //12
            c.drawLine((float) (y- (float)(trunk.getLuggage(i).getxView()*1.19)  + (float)(trunk.getLuggage(i).getyView()*5.38)- trunk.getLuggage(i).getLengthScale() / Math.sqrt(2.0)), (float) (x - trunk.getLuggage(i).getHeightScale() + trunk.getLuggage(i).getLengthScale() / Math.sqrt(2.0)- (float)(trunk.getLuggage(i).getzView()*2.85)+ (float)(trunk.getLuggage(i).getxView()*1.2)),y+(float)(trunk.getLuggage(i).getyView()*5.38)- (float)(trunk.getLuggage(i).getxView()*1.19) , x - trunk.getLuggage(i).getHeightScale() - (float)(trunk.getLuggage(i).getzView()*2.85)+ (float)(trunk.getLuggage(i).getxView()*1.2), cLuggageEnd);
            //6
            c.drawLine(y- (float)(trunk.getLuggage(i).getxView()*1.19) +(float)(trunk.getLuggage(i).getyView()*5.38), x - trunk.getLuggage(i).getHeightScale() - (float)(trunk.getLuggage(i).getzView()*2.85)+ (float)(trunk.getLuggage(i).getxView()*1.2),y   + trunk.getLuggage(i).getWidthScale() + (float)(trunk.getLuggage(i).getyView()*5.38)- (float)(trunk.getLuggage(i).getxView()*1.19), x - trunk.getLuggage(i).getHeightScale() -(float)(trunk.getLuggage(i).getzView()*2.85) + (float)(trunk.getLuggage(i).getxView()*1.2), cLuggageEnd);
            //7
            c.drawLine(y- (float)(trunk.getLuggage(i).getxView()*1.19)  + trunk.getLuggage(i).getWidthScale() + (float)(trunk.getLuggage(i).getyView()*5.38), x - trunk.getLuggage(i).getHeightScale() -(float)(trunk.getLuggage(i).getzView()*2.85) + (float)(trunk.getLuggage(i).getxView()*1.2),y  + trunk.getLuggage(i).getWidthScale() +(float)(trunk.getLuggage(i).getyView()*5.38)- (float)(trunk.getLuggage(i).getxView()*1.19), x + (float)(trunk.getLuggage(i).getxView()*1.2) - (float)(trunk.getLuggage(i).getzView()*2.85), cLuggageEnd);
            //4
            c.drawLine((float) (y- (float)(trunk.getLuggage(i).getxView()*1.19) + trunk.getLuggage(i).getWidthScale() +(float)(trunk.getLuggage(i).getyView()*5.38)), x + (float)(trunk.getLuggage(i).getxView()*1.2) - (float)(trunk.getLuggage(i).getzView()*2.85),(float) (y - (float)(trunk.getLuggage(i).getxView()*1.19) + trunk.getLuggage(i).getWidthScale() - trunk.getLuggage(i).getLengthScale() / Math.sqrt(2.0)+(float)(trunk.getLuggage(i).getyView()*5.38)), (float) (x + trunk.getLuggage(i).getLengthScale() / Math.sqrt(2.0))-(float)(trunk.getLuggage(i).getzView()*2.85) + (float)(trunk.getLuggage(i).getxView()*1.2), cLuggageEnd);
            //5
            c.drawLine((float) (y- (float)(trunk.getLuggage(i).getxView()*1.19) + trunk.getLuggage(i).getWidthScale()  - trunk.getLuggage(i).getLengthScale() / Math.sqrt(2.0)+(float)(trunk.getLuggage(i).getyView()*5.38)) , (float) (x + trunk.getLuggage(i).getLengthScale() / Math.sqrt(2.0))-(float)(trunk.getLuggage(i).getzView()*2.85) + (float)(trunk.getLuggage(i).getxView()*1.2),(float) (y- (float)(trunk.getLuggage(i).getxView()*1.19) + (float)(trunk.getLuggage(i).getyView()*5.38)- trunk.getLuggage(i).getLengthScale() / Math.sqrt(2.0)) , (float) (x + trunk.getLuggage(i).getLengthScale() / Math.sqrt(2.0)) - (float)(trunk.getLuggage(i).getzView()*2.85) + (float)(trunk.getLuggage(i).getxView()*1.2), cLuggageEnd);//6
            //8
            ...
            c.drawLine((float) (y- (float)(trunk.getLuggage(i).getxView()*1.19)  + (float)(trunk.getLuggage(i).getyView()*5.38)- trunk.getLuggage(i).getLengthScale() / Math.sqrt(2.0)+ trunk.getLuggage(i).getWidthScale()), (float) (x - trunk.getLuggage(i).getHeightScale() + trunk.getLuggage(i).getLengthScale() / Math.sqrt(2.0)- (float)(trunk.getLuggage(i).getzView()*2.85)+ (float)(trunk.getLuggage(i).getxView()*1.2)),(float) (y- (float)(trunk.getLuggage(i).getxView()*1.19)  + (float)(trunk.getLuggage(i).getyView()*5.38)- trunk.getLuggage(i).getLengthScale() / Math.sqrt(2.0)), (float) (x - trunk.getLuggage(i).getHeightScale() + trunk.getLuggage(i).getLengthScale() / Math.sqrt(2.0)- (float)(trunk.getLuggage(i).getzView()*2.85)+ (float)(trunk.getLuggage(i).getxView()*1.2)), cLuggageEnd);
            //12
            c.drawLine(y - (float)(trunk.getLuggage(i).getxView()*1.19) + trunk.getLuggage(i).getWidthScale() + (float)(trunk.getLuggage(i).getyView()*5.38), x - trunk.getLuggage(i).getHeightScale() -(float)(trunk.getLuggage(i).getzView()*2.85) + (float)(trunk.getLuggage(i).getxView()*1.2), (float)(y- (float)(trunk.getLuggage(i).getxView()*1.19)  + (float)(trunk.getLuggage(i).getyView()*5.38)- trunk.getLuggage(i).getLengthScale() / Math.sqrt(2.0)+ trunk.getLuggage(i).getWidthScale()), (float) (x - trunk.getLuggage(i).getHeightScale() + trunk.getLuggage(i).getLengthScale() / Math.sqrt(2.0)- (float)(trunk.getLuggage(i).getzView()*2.85)+ (float)(trunk.getLuggage(i).getxView()*1.2)),cLuggageEnd);
